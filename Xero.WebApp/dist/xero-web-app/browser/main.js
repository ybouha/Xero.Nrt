...
function SidebarComponent_a_23_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("innerHTML", ctx_r1.getIcon(item_r3.icon), \u0275\u0275sanitizeHtml);
    \u0275\u0275advance(2);
...
var SidebarComponent = class _SidebarComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 36, vars: 2, consts: [[1, "sidebar"], [1, "logo"], [1, "logo-mark"], ["width", "22", "height", "22", "viewBox", "0 0 24 24", "fill", "none"], ["width", "24", "height", "24", "rx", "6", "fill", "#4f8ef7"], ["d", "M6 12h12M12 6v12", "stroke", "#fff", "stroke-width", "2.5", "stroke-linecap", "round"], [1, "logo-text"], [1, "logo-version"], [1, "search-wrap"], [1, "search-box"], ["width", "14", "height", "14", "viewBox", "0 0 24 24", "fill", "none", 1, "search-icon"], ["cx", "11", "cy", "11", "r", "8", "stroke", "currentColor", "stroke-width", "2"], ["d", "m21 21-4.35-4.35", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round"], [1, "nav-section"], ["routerLinkActive", "active", "class", "nav-item", 3, "routerLink", 4, "ngFor", "ngForOf"], [1, "spacer"], [1, "nav-section", "bottom"], [1, "user-row"], [1, "avatar"], [1, "user-info"], [1, "user-name"], [1, "user-role"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", 1, "more-icon"], ["cx", "12", "cy", "5", "r", "1.5", "fill", "currentColor"], ["cx", "12", "cy", "12", "r", "1.5", "fill", "currentColor"], ["cx", "12", "cy", "19", "r", "1.5", "fill", "currentColor"], ["routerLinkActive", "active", 1, "nav-item", 3, "routerLink"], [1, "nav-icon", 3, "innerHTML"], [1, "nav-label"]], template: function SidebarComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275element(13, "circle", 11)(14, "path", 12);
        \u0275\u0275elementEnd();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(15, "span");
        \u0275\u0275text(16, "Search\u2026");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(17, "kbd");
        \u0275\u0275text(18, "\u2318K");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(19, "nav", 13);
        \u0275\u0275template(20, SidebarComponent_a_20_Template, 4, 3, "a", 14);
        \u0275\u0275elementEnd();
        \u0275\u0275element(21, "div", 15);
        \u0275\u0275elementStart(22, "nav", 16);
        \u0275\u0275template(23, SidebarComponent_a_23_Template, 4, 3, "a", 14);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275element(33, "circle", 23)(34, "circle", 24)(35, "circle", 25);
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(20);
...
var LayoutComponent = class _LayoutComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LayoutComponent, selectors: [["app-layout"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 4, vars: 0, consts: [[1, "shell"], [1, "main-content"]], template: function LayoutComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LayoutComponent, { className: "LayoutComponent", filePath: "src\\app\\layout\\layout.component.ts", lineNumber: 12 });
})();
