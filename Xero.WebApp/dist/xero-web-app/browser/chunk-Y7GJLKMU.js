...
function NewRunComponent_div_27_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div")(1, "dx-text-area", 40);
...
function NewRunComponent_div_43_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div")(1, "dx-tag-box", 41);
...
function NewRunComponent_div_45_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div")(1, "dx-tag-box", 42);
...
function NewRunComponent_div_69_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 43)(1, "dx-text-box", 44);
    \u0275\u0275listener("onValueChanged", function NewRunComponent_div_69_Template_dx_text_box_onValueChanged_1_listener($event) {
      const i_r7 = \u0275\u0275restoreView(_r6).index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.updateColumnName(i_r7, $event.value));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "dx-select-box", 45);
    \u0275\u0275listener("onValueChanged", function NewRunComponent_div_69_Template_dx_select_box_onValueChanged_2_listener($event) {
      const i_r7 = \u0275\u0275restoreView(_r6).index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.updateColumnType(i_r7, $event.value));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "dx-button", 46);
    \u0275\u0275listener("onClick", function NewRunComponent_div_69_Template_dx_button_onClick_3_listener() {
      const i_r7 = \u0275\u0275restoreView(_r6).index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.removeColumn(i_r7));
    });
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("value", col_r8.name);
    \u0275\u0275advance();
    \u0275\u0275property("items", ctx_r1.columnTypeOptions)("value", col_r8.type);
  }
}
function NewRunComponent_div_70_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 47);
    \u0275\u0275text(1, ' No columns defined. Click "Add Column" to add the first column. ');
    \u0275\u0275elementEnd();
  }
}
function NewRunComponent_dx_load_indicator_73_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "dx-load-indicator", 48);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function NewRunComponent_div_75_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 49)(1, "div", 50);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 51);
    \u0275\u0275element(3, "circle", 52)(4, "path", 53);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
...
function NewRunComponent_div_76_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 56);
    \u0275\u0275element(1, "dx-load-indicator", 57);
...
function NewRunComponent_div_77_Template(rf, ctx) {
  if (rf & 1) {
...
function NewRunComponent_div_78_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(9, "number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 68)(11, "div", 69)(12, "span");
    \u0275\u0275text(13, "Ref Rows");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(16, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div", 69)(18, "span");
    \u0275\u0275text(19, "Tgt Rows");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(22, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "div", 69)(24, "span");
    \u0275\u0275text(25, "Diffs");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(28, "number");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(29, "div", 69)(30, "span");
    ...
    \u0275\u0275pipe(40, "number");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(41, "dx-button", 70);
    \u0275\u0275listener("onClick", function NewRunComponent_div_78_Template_dx_button_onClick_41_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
...
ORDER BY trade_id`;
    ...
    this.formData = {
      ...
      columnSchema: [...this.defaultColumnSchema.map((c) => __spreadValues({}, c))]
    };
  }
  addColumn() {
  ...
  removeColumn(index) {
    ...
    this.formData = __spreadProps(__spreadValues({}, this.formData), { columnSchema: updated });
  }
  updateColumnName(index, name) {
    const updated = this.formData.columnSchema.map((col, i) => i === index ? __spreadProps(__spreadValues({}, col), { name }) : col);
    this.formData = __spreadProps(__spreadValues({}, this.formData), { columnSchema: updated });
  }
  updateColumnType(index, type) {
    const updated = this.formData.columnSchema.map((col, i) => i === index ? __spreadProps(__spreadValues({}, col), { type }) : col);
    this.formData = __spreadProps(__spreadValues({}, this.formData), { columnSchema: updated });
  }
  submitRun() {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewRunComponent, selectors: [["app-new-run"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 79, vars: 33, consts: [[1, "new-run-page"], [1, "page-header"], [1, "subtitle"], [1, "run-layout"], [1, "form-pane"], [1, "card", "form-section"], [1, "section-title"], ["labelMode", "outside", 3, "formData", "showColonAfterLabel"], ["itemType", "group", 3, "colCount"], ["dataField", "scenarioName", "label.text", "Scenario Name", "editorType", "dxTextBox"], ["dataField", "referenceVersion", "label.text", "Reference Version", "editorType", "dxTextBox"], ["dataField", "targetVersion", "label.text", "Target Version", "editorType", "dxTextBox"], ["dataField", "valuationDate", "label.text", "Valuation Date", "editorType", "dxDateBox", 3, "editorOptions"], ["dataField", "provider", "label.text", "Provider", "editorType", "dxSelectBox", 3, "editorOptions"], ["dataField", "timeoutSeconds", "label.text", "Timeout (sec)", "editorType", "dxNumberBox"], ["dataField", "connectionString", "label.text", "Connection String", "editorType", "dxTextBox"], ["label.text", "SQL Query"], [4, "dxTemplate"], ["label.text", "Key Properties"], ["label.text", "Compare Properties (empty = all non-key)"], ["dataField", "enabled", "label.text", "Enabled", "editorType", "dxCheckBox"], ["dataField", "tableName", "label.text", "Table Name", "editorType", "dxTextBox"], [1, "section-title", "section-title-row"], ["text", "+ Add Column", "type", "normal", "stylingMode", "outlined", 3, "onClick"], [1, "section-hint"], [1, "schema-table"], [1, "schema-header"], [1, "col-name-hdr"], [1, "col-type-hdr"], [1, "col-del-hdr"], ["class", "schema-row", 4, "ngFor", "ngForOf"], ["class", "schema-empty", 4, "ngIf"], [1, "submit-row"], ["text", "Execute NRT Run", "type", "default", "stylingMode", "contained", 3, "onClick", "disabled"], ["height", "24", "width", "24", 3, "visible", 4, "ngIf"], [1, "result-pane"], ["class", "idle-panel card", 4, "ngIf"], ["class", "running-panel card", 4, "ngIf"], ["class", "error-panel card", 4, "ngIf"], ["class", "success-panel card", 4, "ngIf"], ["stylingMode", "outlined", 3, "valueChange", "value", "height"], ["stylingMode", "outlined", "placeholder", "e.g. TradeId, Book\u2026", 3, "valueChange", "value", "acceptCustomValue"], ["stylingMode", "outlined", "placeholder", "Leave empty to compare all", 3, "valueChange", "value", "acceptCustomValue"], [1, "schema-row"], ["stylingMode", "outlined", "placeholder", "e.g. TradeId", 1, "col-name-input", 3, "onValueChanged", "value"], ["stylingMode", "outlined", 1, "col-type-input", 3, "onValueChanged", "items", "value"], ["icon", "trash", "type", "danger", "stylingMode", "text", "hint", "Remove column", 3, "onClick"], [1, "schema-empty"], ["height", "24", "width", "24", 3, "visible"], [1, "idle-panel", "card"], [1, "idle-icon"], ["width", "40", "height", "40", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "1.5"], ["cx", "12", "cy", "12", "r", "10"], ["d", "M12 6v6l4 2"], [1, "idle-title"], [1, "idle-sub"], [1, "running-panel", "card"], ["height", "50", "width", "50", 3, "visible"], [1, "error-panel", "card"], [1, "error-icon"], [1, "idle-title", 2, "color", "var(--fail-color)"], [1, "error-msg"], [1, "success-panel", "card"], [1, "result-status"], [1, "badge"], [1, "dot"], [1, "result-headline"], [1, "result-sub"], [1, "result-counters"], [1, "res-row"], ["text", "View Runs", "type", "default", "stylingMode", "contained", "width", "100%", 3, "onClick"]], template: function NewRunComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(55, "div", 5)(56, "div", 22)(57, "span");
        \u0275\u0275text(58, "Column Schema");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(59, "dx-button", 23);
        \u0275\u0275listener("onClick", function NewRunComponent_Template_dx_button_onClick_59_listener() {
          return ctx.addColumn();
        });
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(60, "p", 24);
        \u0275\u0275text(61, " Define the columns that the SQL queries return. These are used to generate a CLR type at runtime. Column names must match the SQL aliases exactly (case-sensitive). ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(62, "div", 25)(63, "div", 26)(64, "span", 27);
        \u0275\u0275text(65, "Column Name");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(66, "span", 28);
        \u0275\u0275text(67, "Type");
        \u0275\u0275elementEnd();
        \u0275\u0275element(68, "span", 29);
        \u0275\u0275elementEnd();
        \u0275\u0275template(69, NewRunComponent_div_69_Template, 4, 3, "div", 30)(70, NewRunComponent_div_70_Template, 2, 0, "div", 31);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(71, "div", 32)(72, "dx-button", 33);
        \u0275\u0275listener("onClick", function NewRunComponent_Template_dx_button_onClick_72_listener() {
          return ctx.submitRun();
        });
        \u0275\u0275elementEnd();
        \u0275\u0275template(73, NewRunComponent_dx_load_indicator_73_Template, 1, 1, "dx-load-indicator", 34);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(74, "aside", 35);
        \u0275\u0275template(75, NewRunComponent_div_75_Template, 12, 0, "div", 36)(76, NewRunComponent_div_76_Template, 6, 1, "div", 37)(77, NewRunComponent_div_77_Template, 7, 1, "div", 38)(78, NewRunComponent_div_78_Template, 42, 31, "div", 39);
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(12);
        ...
        \u0275\u0275advance(4);
        \u0275\u0275property("editorOptions", \u0275\u0275pureFunction0(26, _c0));
        \u0275\u0275advance(4);
        ...
        \u0275\u0275property("colCount", 2);
        \u0275\u0275advance(2);
        \u0275\u0275property("editorOptions", \u0275\u0275pureFunction1(31, _c1, ctx.providerOptions));
        \u0275\u0275advance(17);
        \u0275\u0275property("ngForOf", ctx.formData.columnSchema);
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.formData.columnSchema.length === 0);
        \u0275\u0275advance(2);
